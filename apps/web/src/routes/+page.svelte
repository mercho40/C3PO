    ...
    const onScroll = () => {
      ...
      comoFuncionaArrowVisible =
        ...
        (heroSection?.offsetHeight ?? 0) +
          (comoFuncionaSection?.offsetHeight ?? Infinity) * 0.4;
    };
...
{#snippet voiceIcon()}
  ...
  >
    <path
      d="M9 3.5C9 2.39543 8.10457 1.5 7 1.5C5.89543 1.5 5 2.39543 5 3.5V6.5C5 7.60457 5.89543 8.5 7 8.5C8.10457 8.5 9 7.60457 9 6.5V3.5Z"
      stroke="currentColor"
      stroke-width="1.3"
    />
    <path
      d="M3 7C3 8.06087 3.42143 9.07828 4.17157 9.82843C4.92172 10.5786 5.93913 11 7 11M7 11C8.06087 11 9.07828 10.5786 9.82843 9.82843C10.5786 9.07828 11 8.06087 11 7M7 11V12.5"
      stroke="currentColor"
      stroke-width="1.3"
      stroke-linecap="round"
    />
...
{#snippet howCard(
  ...
  >
    <div
      class="flex flex-col justify-center gap-4 px-7 py-10 sm:px-12 {imgRight
        ? ''
        : 'md:order-2'}"
    >
      <h3
        class="font-heading text-3xl font-bold tracking-tight text-[#eaf1ff] sm:text-[40px] sm:leading-[1.05]"
      >
        {title}
      </h3>
      <p class="max-w-[480px] text-base leading-relaxed text-[#8a96ad]">
        {description}
      </p>
    </div>
    <div
    ...
    >
      <img
        src={img}
        alt={imgAlt}
        class="max-h-[260px] w-full rounded-[10px] object-contain"
      />
    </div>
  </div>
{/snippet}
...
{#snippet featureCard(
  ...
  >
    <div
      class="flex size-9 items-center justify-center rounded-lg bg-[rgba(159,197,255,0.14)] text-[#9fc5ff]"
    >
      {#if icon === "voice"}{@render voiceIcon()}{:else}{@render chartIcon()}{/if}
    </div>
    <h3
      class="font-heading text-[22px] font-bold tracking-tight text-[#eaf1ff]"
    >
      {title}
    </h3>
...
<div
  class="relative min-h-screen overflow-x-hidden bg-[#05070d] font-display text-[#eaf1ff]"
>
  <!-- Radial glows -->
  <div
  ...
  <!-- Navbar -->
  <nav
    class="fixed inset-x-0 top-4 z-50 mx-auto grid max-w-[1461px] grid-cols-[1fr_auto_1fr] items-center px-6"
  >
    <img
      src="/logo.svg"
      alt="C3PO"
      class="h-9 w-auto justify-self-start object-contain drop-shadow-[0_0_12px_rgba(126,229,255,0.45)]"
    />
    <div
    ...
    >
      <a href="#como-funciona" class="transition-colors hover:text-white"
        >¿Cómo funciona?</a
      >
      <a href="#features" class="transition-colors hover:text-white"
        >Características</a
      >
      <a href="#contacto" class="transition-colors hover:text-white"
        >Contactanos</a
      >
    </div>
  ...
  >
    <h1
      class="font-display text-7xl font-medium tracking-[-0.04em] text-[#d9d9d9] sm:text-[116px] sm:leading-none"
    >
      C3PO
    </h1>
    <p class="mt-6 max-w-[660px] text-lg leading-relaxed text-[#8a96ad]">
      Un espacio para operar robots. Comandos por voz, telemetría en tiempo
      real, navegación autónoma y control de seguridad — todo desde el
      navegador.
    </p>
    <form
    ...
    >
      <input
        ...
        required
        class="h-10 flex-1 bg-transparent px-5 font-mono text-[13px] text-[rgba(234,241,255,0.71)] placeholder:text-[rgba(234,241,255,0.5)] focus:outline-none"
      />
      <button
        type="submit"
        aria-label="Unirme"
  ...
  <!-- How it works -->
  <section
    bind:this={comoFuncionaSection}
    id="como-funciona"
    class="relative px-6 pt-24 pb-16"
  >
    <div class="mx-auto max-w-[1200px]">
      <h2
        class="mb-16 text-center font-display text-4xl font-medium tracking-tight text-[#eaf1ff] sm:text-[60px]"
      >
        ¿Cómo funciona?
      </h2>
  ...
  <section id="features" class="relative px-6 pt-16 pb-32">
    <div class="mx-auto max-w-[1200px]">
      <h2
        class="mb-14 text-center font-display text-4xl font-medium tracking-tight text-[#eaf1ff] sm:text-[60px]"
      >
        Features
      </h2>
  ...
  <footer
    id="contacto"
    class="border-t border-[rgba(180,210,255,0.08)] px-6 pt-16 pb-10"
  >
    <div class="mx-auto max-w-[1200px]">
      <div class="grid grid-cols-2 gap-12 md:grid-cols-4">
        ...
        <div class="col-span-2 md:col-span-1">
          <img
            src="/logo.svg"
            alt="C3PO"
            class="mb-4 h-8 w-auto object-contain drop-shadow-[0_0_12px_rgba(126,229,255,0.45)]"
          />
          ...
          <div class="flex items-center gap-3">
            <a
              ...
              aria-label="LinkedIn"
              class="flex size-8 items-center justify-center rounded-lg border border-[rgba(180,210,255,0.08)] text-[#8a96ad] transition-colors hover:border-[rgba(180,210,255,0.3)] hover:text-[#eaf1ff]"
            >
        ...
        <div>
          <h4
            class="mb-4 text-xs font-semibold tracking-widest text-[#eaf1ff] uppercase"
          >
            Producto
          </h4>
          <ul class="space-y-3 text-sm text-[#8a96ad]">
            <li>
              <a
                href="#como-funciona"
                class="transition-colors hover:text-[#eaf1ff]"
                >¿Cómo funciona?</a
              >
            </li>
            <li>
              <a href="#features" class="transition-colors hover:text-[#eaf1ff]"
                >Características</a
              >
            </li>
            <li>
              <a href="/chat" class="transition-colors hover:text-[#eaf1ff]"
                >Chat</a
              >
            </li>
            <li>
              <a
                href="/dashboard"
                class="transition-colors hover:text-[#eaf1ff]">Dashboard</a
              >
            </li>
          </ul>
        </div>
